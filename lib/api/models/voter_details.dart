...
class VoterDetails {
  ...
  /// copyWith method for updating specific fields immutably
  VoterDetails copyWith({
    String? id,
    int? serialNo,
    String? name,
    String? guardianName,
    ...
    return VoterDetails(
      ...
      isSureVote: isSureVote ?? this.isSureVote,
      isStayingOutside: isStayingOutside ?? this.isStayingOutside,
      stayingLocation: stayingLocation ?? this.stayingLocation,
      stayingStatus: stayingStatus ?? this.stayingStatus,
      ...
      locBodyType: locBodyType ?? this.locBodyType,
      party: party ?? this.party,
      voterConcern: voterConcern ?? this.voterConcern,
      voted: voted ?? this.voted,
      bhagNo: bhagNo ?? this.bhagNo,
